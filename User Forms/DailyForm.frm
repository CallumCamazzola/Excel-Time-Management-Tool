VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} DailyForm 
   Caption         =   "UserForm1"
   ClientHeight    =   2930
   ClientLeft      =   100
   ClientTop       =   420
   ClientWidth     =   7780
   OleObjectBlob   =   "DailyForm.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "DailyForm"
...
Private Sub CommandButton1_Click()
    ...
    Select Case WorkLoad
        Case "Very Light": HoursInDay = HoursInDay * 0.2
        Case "Light": HoursInDay = HoursInDay * 0.5
        Case "Normal: HoursInDay = HoursInDay * 1"
        Case "Heavy": HoursInDay = HoursInDay * 1.5
        Case "Very Heavy": HoursInDay = HoursInDay * 2
    End Select
...
Private Sub UserForm_Initialize()
    'Intialize dropdown
    ComboBox1.AddItem ("Very Light")
    ComboBox1.AddItem ("Light")
    ComboBox1.AddItem ("Normal")
    ComboBox1.AddItem ("Heavy")
    ComboBox1.AddItem ("Very Heavy")
